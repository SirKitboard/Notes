...
class Parser(tpg.Parser):
    ...
    token function '[A-Za-z][A-Za-z0-9]*' $ Functions.Function $;
    ...
    | block/a
    | function/f ";" $ a = Assign.AssignFunction(f,[]) $
    | function/f "\([ ]*\)" block/s $ a = Assign.AssignFunction(f,s)$
    | "return" expression/a $ print('HI') $
    )
    ;
    ...
    argumentList/a -> variable/a "," argumentList/b $ a = Functions.ArgumentList(a,b) $
    | variable/a $ a = Functions.ArgumentList(a)$
    ;
    """
